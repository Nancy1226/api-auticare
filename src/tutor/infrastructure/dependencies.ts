...
export const getTutorById = new GetTutorByID(tutorFactoryRepository);

export const updateTutor = new UpdateTutorUseCase(tutorFactoryRepository);

export const deleteTutor = new DeleteTutorUseCase(tutorFactoryRepository);
